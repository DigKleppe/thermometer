...
//        #define DC_D GPIO.out_w1ts = (1 << TFT_DC)//;GPIO.out_w1ts = (1 << TFT_DC)
        #define DC_C  gpio_set_level((gpio_num_t) TFT_DC, 0)
        #define DC_D  gpio_set_level((gpio_num_t) TFT_DC, 1)
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  #define CS_H       // No macro allocated so it generates no code
     ...
     //   #define CS_H GPIO.out_w1ts = (1 << TFT_CS)//;GPIO.out_w1ts = (1 << TFT_CS)
		#define CS_L gpio_set_level((gpio_num_t)TFT_CS, 0);
		#define CS_H gpio_set_level((gpio_num_t)TFT_CS, 1);
      #endif
    #else
      #define CS_L
      #define CS_H
